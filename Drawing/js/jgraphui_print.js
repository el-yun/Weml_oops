			...
			if(Access == "public"){
				...
				return Access;
										...
										if(load_class)
										{
											if(load_member)
											{
													var data = JSON.parse(load_member);
											}
											console.log(data);
											for(i = 0; i<load_class.length; i++)
											{
													...
													if(load_member)
													{
																	if(data.diagram[i].class_.variableData != 0)
																	{
																		...
																		{
																			temp_var.= Access_Code_Change(data.diagram[i].class_.variableData[j].access) + " " + data.diagram[i].class_.variableData[j].data + " " + data.diagram[i].class_.variableData[j].name;
																			if(j>0) temp_var.= "<br>";
																	...
																	if(data.diagram[i].class_.functionData != 0)
																	{
																		...
																		{
																			temp_func.= Access_Code_Change(data.diagram[i].class_.functionData[j].access) + " " + data.diagram[i].class_.functionData[j].returns + " " + data.diagram[i].class_.functionData[j].name + "(" + data.diagram[i].class_.functionData[j].param + ")";
																			if(j>0) temp_func.= "<br>";
																		}
																	}
													}
										...
										if(load_conn)
										{
											for(i = 0; i<load_conn.length; i++)
											{
												...
												caller.addConnection(connection);
											}
										}
